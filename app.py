...
def get_mc_stats():
    ...
    # Filter to YES picks
    yes_picks = predictions[predictions["mc_category"] == "YES"] if not predictions.empty and "mc_category" in predictions.columns else (predictions[predictions["decision"] == "YES"] if not predictions.empty and "decision" in predictions.columns else pd.DataFrame())
...
def get_legacy_stats():
    ...
    yes_picks = predictions[predictions['decision'] == 'YES' if 'decision' in predictions.columns else predictions['mc_category'] == 'YES'] if not predictions.empty else pd.DataFrame()
...
def get_mc_games():
    ...
    if 'mc_category' in predictions.columns:
        yes_picks = predictions[predictions['decision'] == 'YES' if 'decision' in predictions.columns else predictions['mc_category'] == 'YES'].copy()
        maybe_picks = predictions[predictions['mc_category'] == 'MAYBE'].copy()
        no_picks = predictions[predictions['mc_category'] == 'NO'].copy()
    else:
        # Fall back to old format
        yes_picks = predictions[predictions['decision'] == 'YES' if 'decision' in predictions.columns else predictions['mc_category'] == 'YES'].copy() if 'decision' in predictions.columns else pd.DataFrame()
        maybe_picks = predictions[predictions['decision'] == 'MAYBE' if 'decision' in predictions.columns else predictions['mc_category'] == 'MAYBE'].copy() if 'decision' in predictions.columns else pd.DataFrame()
        no_picks = predictions[predictions['decision'] == 'NO' if 'decision' in predictions.columns else predictions['mc_category'] == 'NO'].copy() if 'decision' in predictions.columns else pd.DataFrame()
